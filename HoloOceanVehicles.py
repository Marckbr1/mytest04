...
class AUV(Vehicle):
    ...
    def create_file_folders(self):
        ...
        os.makedirs(os.path.join(self.root_folder, self.files_folder), exist_ok=True)
        os.makedirs(os.path.join(self.root_folder, self.files_folder, self.pkl_folder), exist_ok=True)
        os.makedirs(os.path.join(self.root_folder, self.files_folder, self.cartesian_image_folder), exist_ok=True)
        os.makedirs(os.path.join(self.root_folder, self.files_folder, self.polar_image_folder), exist_ok=True)
        os.makedirs(os.path.join(self.root_folder, self.files_folder, self.raw_data_folder), exist_ok=True)
        os.makedirs(os.path.join(self.root_folder, self.files_folder, self.meta_data_folder), exist_ok=True)
        os.makedirs(os.path.join(self.root_folder, self.files_folder, self.gt_folder), exist_ok=True)
